...
export default function PublicationsFooterSection() {
  ...
  useEffect(() => {
    ...
    if (!isMobile && canvas && videoEl) {
      ...
      videoEl.src       = '/assets/maahir-reel.mp4'
      videoEl.muted     = true
    ...
    <div ref={wrapperRef} className={styles.wrapper}>
      <div ref={stickyRef} className={styles.sticky}>
        ...
        <div className={styles.mobileFooterBg}>
          <video src="/assets/maahir-reel.mp4" autoPlay muted loop playsInline className={styles.mobileFooterBgImg} />
        </div>
        ...
        <div ref={imageWrapRef} className={styles.imageWrap}>
          <video src="/assets/maahir-reel.mp4" autoPlay muted loop playsInline className={styles.imageEl} />
